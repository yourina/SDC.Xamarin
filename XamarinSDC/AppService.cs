...
namespace XamarinSDC
{
    class AppService
    {
        ...
        public static async Task<AppListModel> LoadMovieListAsync(string menu)
        {
            ...
            else if (menu == "SkiaSharp Samples")
            {
                items = await GetApps(2);
            }
            else if (menu == "FFImageLoading Samples")
            {
                items = await GetApps(3);
            }
            else if (menu == "MicroChart Samples")
            {
                items = await GetApps(6);
            }
        ...
        private static IList<AppInfo> apps = new List<AppInfo>()
        {
            ...
            new AppInfo
            {
                Title = "FFImageLoadingBasic",
                PosterPath = "FFImageLoadingBasic.png",
                OriginalTitle = "FFImageLoading Basic",
                Id = 31,
                Overview = "This example shows Basic operations of CachedImage"
            },
            new AppInfo
            {
                Title = "FFImageLoadingCompare",
                PosterPath = "FFImageLoadingCompare.png",
                OriginalTitle = "FFImageLoading VS Image",
                Id = 32,
                Overview = "This example shows comparison between CachedImage of FFImageLoading and Image"
            },
            //new AppInfo
            //{
            //    Title = "Xamanimation",
            ...
            {
                Title = "MicroChart1",
                PosterPath = "BarChart.png",
                OriginalTitle = "Bar Chart",
                Id = 61,
                AppId = "org.tizen.example.SmartHotel.Clients.Tizen",
                Overview = ""
            },
            ...
            {
                Title = "MicroChart2",
                PosterPath = "PointChart.png",
                OriginalTitle = "Point Chart",
                Id = 62,
                AppId = "org.tizen.example.SmartHotel.Clients.Tizen",
                Overview = ""
            },
            ...
            {
                Title = "MicroChart3",
                PosterPath = "LineChart.png",
                OriginalTitle = "Line Chart",
                Id = 63,
                AppId = "org.tizen.example.SmartHotel.Clients.Tizen",
                Overview = ""
            },
            ...
            {
                Title = "MicroChart4",
                PosterPath = "DonutChart.png",
                OriginalTitle = "Donut Chart",
                Id = 64,
                AppId = "org.tizen.example.SmartHotel.Clients.Tizen",
                Overview = ""
            },
            ...
            {
                Title = "MicroChart5",
                PosterPath = "RadialGaugeChart.png",
                OriginalTitle = "Radial Gauge Chart",
                Id = 65,
                AppId = "org.tizen.example.SmartHotel.Clients.Tizen",
                Overview = ""
            },
            ...
            {
                Title = "MicroChart6",
                PosterPath = "RadarChart.png",
                OriginalTitle = "Radar Chart",
                Id = 66,
                AppId = "org.tizen.example.SmartHotel.Clients.Tizen",
                Overview = ""
            }
