...
namespace XamarinSDC
{
    ...
    public static class Data
    {
        ...
        public static Chart[] CreateXamarinSample()
        {
            ...
            foreach (var item in PositiveData)
            {
                var newEntry = new Entry(item.value)
                {
                    Label = item.label,
            ...
            return new Chart[]
            {
                        new BarChart() { Entries = otherEntries },
                        new PointChart() { Entries = otherEntries, BackgroundColor = SKColor.Parse("#222222") },
                        new LineChart()
                        {
                        ...
                        new DonutChart() { Entries = otherEntries, BackgroundColor = SKColor.Parse("#222222") },
                        new RadialGaugeChart() { Entries = otherEntries },
                        new RadarChart() { Entries = otherEntries, BackgroundColor = SKColor.Parse("#222222") },
            };
        }
